<?php
/**
 * The template for displaying category "news" (NL).
 *
	...
	<div id="primary" class="content-area">
		...
		if ( have_posts() ) :
			...
			while ( have_posts() ) :
				 ...
				 */
				get_template_part( 'template-parts/content-nieuws', get_post_format() );
			...
			get_template_part( 'template-parts/content-nieuws', 'none' );
