<?php
/**
 * Template Name: Bibliotheque-Search
...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			echo '<h5> <a href="/library/"> <span class="search-back-button-icon"><</span> <span>Back</a></span></h5>';
			echo '<h1 class="entry-title">Search Results: ' . $searched_value . '</h1>';
			...
			if ( $bibliotheque_search_query->have_posts() ) {
				...
				echo '</ol>';
				echo '<br>';
				echo $bibliotheque_search_query->found_posts . ' result(s) found ';
				...
				the_posts_pagination(
				 ...
				 echo '<br><h4>No search results found. </h4>';
			}
