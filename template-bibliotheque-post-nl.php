<?php
/**
 * Template Name: Bibliotheque-Post-NL
	...
	<main id="main" class="site-main" role="main">
		...
		<div class="library-desc">
			...
			<div class="library-desc-author">
				<span class="library-desc-heading">Schrijver: </span>
			...
			<div class="library-desc-year">
				<span class="library-desc-heading">Jaar (Originele Editie): </span>
				<span><?php echo get_post_meta( $requested_item, 'yearoriginal', true ); ?></span>
				<span> • </span>
				<span class="library-desc-heading">Jaar (huidige editie): </span>
