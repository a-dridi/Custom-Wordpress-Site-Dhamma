<?php
/**
 * Template Name: Bibliotheque-Search-NL
...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			echo '<h5> <a href="/nl/bibliotheek/"> <span class="search-back-button-icon"><</span> <span>Terug</a></span></h5>';
			echo '<h1 class="entry-title">Zoekresultaten: ' . $searched_value . '</h1>';
			...
			if ( $bibliotheque_search_query->have_posts() ) {
				...
				echo '</ol>';
				echo '<br>';
				echo $bibliotheque_search_query->found_posts . ' resultaat(en) gevonden. ';
				...
				the_posts_pagination(
				 ...
				 echo '<br><h4>Geen zoekresultaten gevonden. </h4>';
			}
