<?php
/**
 * Template Name: Bibliotheque-Post-FR
    ...
    <main id="main" class="site-main" role="main">
        ...
        <div class="library-desc">
            ...
            <div class="library-desc-year">
                <span class="library-desc-heading">An (Edition originale): </span>
                <span><?php echo get_post_meta( $requested_item, 'yearoriginal', true ); ?></span>
                <span> • </span>
                <span class="library-desc-heading">Année (édition actuelle/présente): </span>
