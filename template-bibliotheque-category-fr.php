<?php
/**
 * Template Name: Bibliotheque-Category-FR
...
<div id="primary" class="content-area">
	<main id="main" class="site-main" role="main">
		...
		<header class="page-header">
			<h1 class="main-title">
				<?php
					echo get_bibliotheque_categoy_name_fr( $requested_category );
				?>
			</h1>
		</header><!-- .page-header -->
		...
		<?php require_once 'dhamma_fr_bibliotheque_categories_menu.php'; ?>
		</div>
		<br>

		<form action="/fr/bibliotheque-recherche" method="get">
			<div class="bibliotheque-search">
				<div>
					<span class="bibliotheque-search-box-heading">Rechercher: </span><input type="text"
				...
				<div>
					<input type="submit" value="Rechercher" class="bibliotheque-search-button">
				</div>
			</div>
		</form>
